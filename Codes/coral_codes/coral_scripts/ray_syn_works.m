...
% gamma accounts for the angle between particle motion and the station component
gamma=zeros(size(p));
...
% included and the phase shifts are calculate for near vertical incidence only

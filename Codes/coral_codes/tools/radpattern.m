function u = radpattern( cmt, theta, phi, plotsel )
%   radpattern    calculate moment tensor radiation pattern
% usage: u = radpattern( cmt, theta, phi, plotsel )
%
% input arguments:
%
...
% pp. 114-118, have been used.  This returns FP, FSV, FSH of equations 
% 4.84-4.86, though they are calculated using the form given in 4.91

function odata = STdecimate(idata,r,nfilt,option)
%DECIMATE Resample data at a lower rate after lowpass filtering.
%   This code is identical to the decimate routine distributed by MATLAB
%   except that the output timeseries is aligned on the first sample rather
%   than on the last sample.  K C Creager, Feb 16, 2004.
...
%   $Revision: 1.7 $  $Date: 2002/03/28 17:27:35 $
...
% so end effects can be obliterated.
  ...
  nbeg = 1;   % modified to aligh the input and output time series on the first sample
	%nbeg = r - (r*nout - nd);
